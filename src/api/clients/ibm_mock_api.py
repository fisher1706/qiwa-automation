...
class IBMMockApi:
    ...
    def get_work_permit_requests_from_ibm(
        self, body: ibm.payloads.GetWorkPermitRequestsRq
    ...
    def get_saudization_certificate_from_ibm(
        self, body: ibm.payloads.GetSaudiCertificateRq
    ...
    def validate_establishment_saudization_in_ibm(
        self, body: ibm.payloads.ValidEstSaudiCertificateRq
    ) -> IBMResponseData:
        payload = {
    ...
    def get_change_occupation_requests_from_ibm(
        self, body: Body
    ) -> IBMResponseData[ibm.searchchangeoccupation.Body]:
        payload = {
        ...
        assert_status_code(response.status_code).equals_to(HTTPStatus.OK)
        json_model = IBMResponse[ibm.searchchangeoccupation.Body].parse_obj(response.json())
