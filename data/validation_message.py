...
class ApiMessage:
    INVALID_CREDENTIALS_AR = "الرجاء التحقق من اسم المستخدم او كلمة المرور"
    INVALID_OTP = "رمز التحقق غير صحيح, الرجاء المحاولة مرة اخرى "
    UNCONFIRMED_EMAIL = " الرجاء تسجيل الدخول برقم رقم الهوية / الإقامة"
    SESSION_EMPTY = "عفوا، لقد أدخلت الرمز الخاطئ عدة مرات، يرجى إدخال رقم الهوية أو البريد الإلكتروني للتسجيل الدخول"
    PHONE_TAKEN = (
        "Sorry, It appears that the mobile number is associated with another Qiwa account. "
        "Please update your mobile number."
    )
    INVALID_PERSONAL_NUMBER = "الرجاء التحقق من رقم الهوية المدخل"
    FORBIDDEN_BY_GATEWAY = "Forbidden by Qiwa Gateway"
    RESTRICTED_BY = {
        "user": "Restricted access by rule 'user?'",
        "member": "Restricted access by rule 'member?'",
    }
    EMPTY_ABSHER = "عذرا، أنت غير مسجل في أبشر"
    SAUDI_RED_NITAQ_EN = (
        "We apologize for not processing your request, your establishment is in the red or "
        "yellow  range of Nitaqat, "
    )
    SAUDI_RED_NITAQ_AR = (
        "عفواً، هذه الخدمة غير متاحة للمنشآت في"
        " النطاق الأصفر والأحمر، الرجاء رفع نسبة التوطين للاتسفادة من الخدمات "
    )
    SAUDI_RED_NITAQ_CODE = "SC-009"
    CAN_NOT_TERMINATE = "You can’t terminate your subscription"
    SOMETHING_WENT_WRONG = "Sorry, something went wrong. Please try again."
    WP_VALIDATE_INVALID_USER_ID = (
        "Sorry, we cannot issue- renew working permit because the border ID or border "
        "number is invalid "
    )
    WP_CALCULATE_INVALID_USER_ID = (
        "Sorry, we cannot process your request because the laborer job does not fall "
        "under investment job"
    )
    INVALID_WP_PERIOD = "The period of the work permit is incorrect"
    INVALID_RESTORE_TOKEN = "تم انتهاء صلاحية الرابط. الرجاء المحاولة مرة أخرى."


class ApiMessageLaborerSSO:
    INVALID_CREDENTIALS_EN = "Login or password is incorrect"
    INCORRECT_CREDENTIALS = "Login or password is incorrect"
    WRONG_OTP = "You entered the wrong code. Please, try again"
    WRONG_OTP_TOO_MANY_ATTEMPTS = (
        "Sorry, you have entered an incorrect code too many times, please click on the "
        "link below to receive a new code."
    )
    WRONG_PASSWORD = "You entered the wrong password"
    PASSWORD_DOESNT_MATCH = "Password and confirmation password should be equal"
    REGISTER_USER = "User is already registered"
    WRONG_HSM_TOO_MANY_ATTEMPTS = "Too many attemps for init HSM. Try later"
