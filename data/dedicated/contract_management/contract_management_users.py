...
laborer_saudi_not_in_the_establishment = Laborer(
    personal_number=1061653844, birthdate="08-06-1402"
)
laborer_expatriate = Laborer(personal_number=2243635881, birthdate="01-01-1980")
laborer_expatriate_not_in_the_establishment = Laborer(
    personal_number=2191542147, birthdate="01-01-1978"
)
